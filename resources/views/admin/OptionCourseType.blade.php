                ...
                <div class="flex flex-col sm:flex-col lg:flex-row xl:flex-row md:flex-row justify-center items center  container   ">
                    <div class="py-12 sm:py-12 md:py-6 lg:py-6 xl:py-6 px-8 w-full md:max-w-min sm:w-full bg-white z-30">
                       <div class="text-center py-4 px-7">
                            <h1 class="text-gray-700 text-4xl font-black">Create Category</h1>
                            <p class="text-gray-500  mt-2">Create a course category</p>
                        </div>
                        <a href="{{route('Add-CourseType')}}"><button class="w-full mt-6 mb-3 py-2 text-white font-semibold bg-gray-700 hover:shadow-xl duration-200 hover:bg-gray-800">Create</button></a>
                    </div>
